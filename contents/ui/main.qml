    ...
    compactRepresentation: Loader {
        ...
        TapHandler {
            property bool wasExpanded: false
                ...
                wasExpanded = cambridgedictroot.expanded;
            }
            onTapped: cambridgedictroot.expanded = !wasExpanded
        }
        ...
        Item {
            ...
            WebEngineView {
                ...
                readonly property bool useMinViewWidth: plasmoid.configuration.useMinViewWidthh
                    ...
                    WebEngineProfile {
                        id: cambridgedictprofile
                        httpUserAgent: getUserAgent()
                        storageName: "cambridgedict"
                        offTheRecord: false
                        httpCacheType: WebEngineProfile.DiskHttpCache
                        persistentCookiesPolicy: WebEngineProfile.ForcePersistentCookies
                    }

                    profile: cambridgedictprofile
...
MouseArea {
    ...
    {
        cambridgedictwebview.goBack();
    } else if (mouse.button === Qt.ForwardButton) {
    cambridgedictwebview.goForward();
}
}
}
}
